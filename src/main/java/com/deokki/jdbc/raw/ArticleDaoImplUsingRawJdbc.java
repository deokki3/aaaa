...
public class ArticleDaoImplUsingRawJdbc implements ArticleDao {
	 ...
	 * 목록 가져오는 sql
	 */
	static final String LIST_ARTICLES = "SELECT articleId, title, content, UserId, name, cdate FROM article LIMIT 20";
	...
	public ArticleDaoImplUsingRawJdbc() {
		ds = new MariaDbDataSource(
				"jdbc:mariadb://localhost:3306/deokkidb?user=deokki&password=rlejr579");
	}
